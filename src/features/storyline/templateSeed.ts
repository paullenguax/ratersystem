...
//
// Resynced 2026-09-16 from a real `template.json` export of the live
// `storyline_template/current` document (StorylineTemplateEditorPage's
// "Export template.json" button) — this file had drifted from live wording
// by weeks in several places (see [[feedback-storyline-template-script-edits]]).
// Treat this as accurate as of that export; it will drift again as the live
// template keeps getting edited in the app, since nothing keeps the two in
// sync automatically. Don't hand-edit this file to "fix" wording without a
// fresh export to check against — see the memory above for why.
  ...
  const rows: Omit<TemplateSlide, 'id' | 'order'>[] = [
    {
      ...
      notes:
        'If this is not the right version, reject it and ask the Administrator to change the version in Test Diary.\n\n' +
        'If you need to fit this interface better to your screen, use Ctrl and + or Ctrl and - on your keyboard to ' +
        'adjust it (Ctrl and 0 resets it back to default).',
      scriptText:
        'Please check the information carefully to ensure you are delivering the most appropriate version to the ' +
        'correct candidate.\n\n' +
        'If this is not the right version, reject it and ask the Administrator to change the version in Test Diary.',
      slotSpec: {},
    },
    {
      ...
      notes:
        'In real use these fields will be filled in from the booking system automatically. \n\n' +
        'For now, enter them by hand as a final "is this the right candidate/test" check before continuing. \n\n' +
        'They also fill in the {Centre Name}/{Test Number}/{Examiner Name}/{Candidate Name} tokens in the Preamble below.',
    ...
    },
    {
      ...
      notes:
        ...
        'If the Candidate Screen does not open immediately, click the Screen icon above and wait for the indicator ' +
        'to turn green before continuing as this means that all the test content has been loaded successfully.',
      scriptText: "Don't forget to check...",
      checklistItems: [
        { text: 'Candidate screen working and visible to the candidate', icon: 'screen' },
        { text: 'Sound is working and volume is sufficient', icon: 'speaker' },
        { text: 'Voice recorder is available and has sufficient battery power' },
        { text: 'Computer is plugged in or sufficiently charged for the test' },
      ],
      slotSpec: {},
    },
    {
    ...
    {
      // startsTestTimer moved here from "Invite candidate" at some point via
      // a live-only edit (confirmed against the 2026-09-16 template.json
      // export) — the session timer/media-readiness gate now activates one
      // slide later than the seed used to have it.
      kind: 'instruction',
      label: 'Preamble',
      candidateState: 'Logo',
    ...
    },
    {
      ...
      scriptText:
        ...
        'This is an aviation English communication test. Your knowledge of operational procedures is not being ' +
        'assessed.\n\n' +
        'During the test, speak as clearly as possible to demonstrate that you can speak clearly for international ' +
        'listeners.\n\n' +
    ...
    },
    {
      ...
      notes:
        ...
        '- **Why...**?/**Why not**?\n\n' +
        'If the candidate is speaking too quickly to be understood easily, say "**Can you slow down and speak as ' +
        'clearly as possible, please**".',
      scriptText:
    ...
    },
    {
      ...
      candidateInstructions: [
        ...
        { text: '[ Take notes to explain all the details. ]', color: '#c00000' },
      ],
      scriptText:
    ...
    },
    {
      ...
      notes:
        ...
        'more about ____?**"\n\n' +
        'If the candidate\'s is speaking too fast and/or the response is unclear, say "**Can you slow down and ' +
        'speak as clearly as possible, please?**" or "**Can you explain what you mean further?**", as appropriate.',
      scriptText:
        ...
        '{audio}\n\n' +
        'Please now respond to the 2 prompts on screen in as much detail as possible.',
      slotSpec: { audio: 'single', maxPlays: 1, volumeCheck: true },
    },
    {
      // candidateState confirmed as 'Logo' (not 'Task2') in the live
      // 2026-09-16 export — a live-only change from what this seed used to
      // have; transcribed as-is rather than "corrected" back.
      kind: 'audio_response',
    ...
    },
    {
      ...
      // "Do you have any questions?" lands under the Example player, not
      // before it.
    ...
    },
    {
      ...
      notes:
        ...
        'Use the prompt "**Report the message**" if candidates do not naturally respond themselves. Otherwise, ' +
        'stay silent. Avoid prompting candidates to repeat recordings - they should ask themselves.\n\n' +
        'If candidates do not explain who is speaking, prompt them to do so with "**And who is speaking?**"\n\n' +
        'If the candidate\'s is speaking too fast and/or the response is unclear, say "**Can you slow down and ' +
        'speak as clearly as possible, please?**" or "**Can you explain what you mean further?**", as appropriate.\n\n' +
        'You should not play the recordings more than two times unless something unexpected distracts the ' +
        'candidate during plays. You can (if necessary) reactivate the recording for a further play using the ' +
        'refresh symbol next to the ticks.',
    ...
    },
    {
      ...
      notes:
        'Stop the Recording.\n\n' +
        'Ensure you click the **✓ Finish** button to complete the test process.\n\n' +
