...
export function StorylineVersionEditorPage() {
  ...
  function handlePreview() {
    ...
    previewStorylineVersion(resolveItems(template.slides, test?.variables, slotContent, selectedParts, formatTestDisplayName(test?.name ?? '', versionLabel)), template.theme)
  }
